...
def addcl2(X, transformer, exclude_col):
    ...
    if exclude_col[0]:
        ...
        zeros_noscale = np.where(zero_var_notrf.variances_ > 0, True, Fasle)
...
class TreeOrdination(ClassifierMixin, BaseEstimator):
    ...
    def plot_importance_global(self, X, y, class_name, n_features = 10, axis = 0, summary = "median", **kwargs):
        ...
        return self.feature_importance_explainer.plot_importance(X_transformed[y_locs], n_features, class_name, axis, summary, **kwargs)
    ...
    def plot_importance_local(self, X, n_features = 10, axis = 0, **kwargs):
        ...
        return self.feature_importance_explainer.plot_importance(X_transformed, n_features, class_name = None, axis = axis, summary = None, **kwargs)
